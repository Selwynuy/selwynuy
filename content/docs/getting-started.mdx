...
Settle the conventions that keep this codebase legible as it grows, then make it yours.

<NextStep href="/docs/project-setup">Project Setup and Conventions</NextStep>
