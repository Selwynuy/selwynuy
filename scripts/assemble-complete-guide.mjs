...
const cover = `  <header class="cover">
    ...
    <h1 class="cover-title display">The<br /><em>Ultimate</em><br />Guide</h1>
    <p class="cover-sub">
...
const colophon = `  <footer class="colophon">
    ...
    <span>The Ultimate Guide · The Foundations · 2026.07</span>
  </footer>`;
...
<title>${title}</title>
<!--
  Piece of The Ultimate Guide (The Foundations, complete edition). GENERATED by
...
const pieces = [
  ["00-front.html", doc("The Ultimate Guide — The Foundations, Complete Edition", `${cover}\n${rights}\n${mtoc}\n  ${intro}`, INTRO_CSS)],
